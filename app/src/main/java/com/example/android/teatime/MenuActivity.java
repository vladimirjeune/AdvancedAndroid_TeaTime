...
public class MenuActivity extends AppCompatActivity implements ImageDownloader.DelayerCallback {
    ...
    protected void onStart() {
        super.onStart();  // Placed here so that the idlingResource has time to register. Activity Created=>Before Called=>This done=> Then delay done
...
//        mTeas = new ArrayList<>();
//        mTeas.add(new Tea(getString(R.string.black_tea_name), R.drawable.black_tea));
//        mTeas.add(new Tea(getString(R.string.green_tea_name), R.drawable.green_tea));
//        mTeas.add(new Tea(getString(R.string.white_tea_name), R.drawable.white_tea));
//        mTeas.add(new Tea(getString(R.string.oolong_tea_name), R.drawable.oolong_tea));
//        mTeas.add(new Tea(getString(R.string.honey_lemon_tea_name), R.drawable.honey_lemon_tea));
//        mTeas.add(new Tea(getString(R.string.chamomile_tea_name), R.drawable.chamomile_tea));
...
//        TeaMenuAdapter adapter = new TeaMenuAdapter(this, R.layout.grid_item_layout, mTeas);
